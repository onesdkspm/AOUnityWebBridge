...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AOUnityWebBridge",
            url: "https://yw-depot-nexus.100bt.com/repository/onesdk-ios-trunk/spm/AOUnityWebBridge/2.0.3/AOUnityWebBridge.xcframework.zip",
            checksum: "7961ef177280966872ee512146a6065a6527979123752162b6b8b8eadbc6dfee"
        )
    ]
)
